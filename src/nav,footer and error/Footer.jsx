...
export default function Footer() {
  ...
  const handlealert = () => {
    toast.error("You Are Already Log In.  First You Have To LogOut!");
  };
    ...
    >
      ...
      <footer data-aos="fade-up" className="footer p-10 container mx-auto">
        <nav data-aos="fade-up">
          ...
          <Link to={`/carftItem`} className="link link-hover">
            Carft Item
          </Link>
          <Link to={`/addCarftItem`} className="link link-hover">
            Add CarftItem
          </Link>
          <Link to={`/profile`} className="link link-hover">
            Profile
          </Link>
          <Link to={`/myCraftList`} className="link link-hover">
            my CraftLis
          </Link>
        </nav>
        <nav data-aos="fade-up">
          <h6 className="footer-title">Juin With</h6>
          <Link
            to={`/login`}
